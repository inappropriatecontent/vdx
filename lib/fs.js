...
export const file = async(handle) => {
        ...
        const ext = file.kind.replace('video/', '.'),
                ...
                paths = await handle.dir.resolve(handle.file);
        ...
        path = `file:///media/removable/${handle.dir.name}/${paths.join('/')}`,
...
export async function getDrive(options = {}) {
